...
if __name__ == "__main__":
    # main()
    milvus = MilvusConnector("http://192.168.0.104:19530", "root:S1nexcel123.", "sinexcel_ai_vector")
    collections = asyncio.run(milvus.list_collections())
    print(collections)

    collection_stats = asyncio.run(milvus.get_collection_stats('ems_collection'))
