...
nltk_data_path = os.path.join(current_dir, "..", "datasource", "nltk_data")
nltk_data_path = os.path.normpath(nltk_data_path)
...
if __name__ == "__main__":
    ...
    file_path = "D:\\AI_文档\\技术文档\\EMS智能助手.docx"

    print(f"处理文件: {file_path}")

    with open(file_path, "rb") as f:
        file_bytes = f.read()
    secs, tbls = parser(file_bytes)
