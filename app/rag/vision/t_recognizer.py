...
from app.rag.vision.seeit import draw_box
from app.rag.vision import LayoutRecognizer, TableStructureRecognizer, OCR, init_in_out
import argparse
import re
import numpy as np
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', help="Directory where to store the output images. Default: './layouts_outputs'",
                        default="D:\\rag_file\\layouts_output")
    parser.add_argument(
        '--threshold',
